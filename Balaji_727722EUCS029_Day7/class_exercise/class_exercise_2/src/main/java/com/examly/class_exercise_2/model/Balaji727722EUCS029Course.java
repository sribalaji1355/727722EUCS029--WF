...
@Entity
public class Balaji727722EUCS029Course {
     ...
     public Balaji727722EUCS029Course() {

     }

     public Balaji727722EUCS029Course(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
