...
public class Balaji727722EUCS029PersonController {
    ...
    public ResponseEntity<List<Balaji727722EUCS029Person>> getAll(@PathVariable String value) {
        List<Balaji727722EUCS029Person> li = ser.start(value);
        if (li.size() > 0) {
    ...
    public ResponseEntity<List<Balaji727722EUCS029Person>> getbyAge(@PathVariable String value) {
        List<Balaji727722EUCS029Person> li = ser.end(value);
        if (li.size() > 0) {
            return new ResponseEntity<>(li, HttpStatus.OK);
        } else {
            return new ResponseEntity<>(HttpStatus.NOT_FOUND);
