...
@Entity
public class Balaji727722EUCS029Village {
    @Id
    ...
    public Balaji727722EUCS029Village(){}
    public Balaji727722EUCS029Village(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
