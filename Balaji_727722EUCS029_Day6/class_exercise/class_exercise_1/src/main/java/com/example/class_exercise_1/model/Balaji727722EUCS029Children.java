...
@Entity
public class Balaji727722EUCS029Children {
     @Id
     private int babyId;
     ...
     public Balaji727722EUCS029Children() {

     }

     public Balaji727722EUCS029Children(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
